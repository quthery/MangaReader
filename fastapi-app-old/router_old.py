...
async def add_manga_test(Cover: UploadFile, CounOfPages, name , desc):
    added = await MangaRepository.add_one(name=name, desc=desc, path="static/mangas/"+name,CountOfPages=CounOfPages, coverPath="static/covers/"+Cover.filename)
